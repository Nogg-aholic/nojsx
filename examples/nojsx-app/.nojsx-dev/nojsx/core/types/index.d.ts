...
type __nojsxJsxDevFn = (tag: string | Function | symbol, props?: any, key?: any, _isStaticChildren?: any, _source?: any, _self?: any) => string;
type __nojsxLivePreviewJsxFn = (tag: string | Function | symbol, props?: JSX.HtmlTag, options?: {
...
export type ExtractParamKeys<T extends string> = T extends `${string}[${infer Param}]${infer Rest}` ? Param | ExtractParamKeys<Rest> : never;
export type RouteParams<T extends string> = ExtractParamKeys<T> extends never ? Record<string, string> | undefined : {
    [K in ExtractParamKeys<T>]: string;
} & Record<string, string>;
export type NavArgs<T extends string> = ExtractParamKeys<T> extends never ? [params?: RouteParams<T>] : [params: RouteParams<T>];
...
declare global {
    ...
    namespace JSX {
        ...
        type HandlerThis = import('nojsx/core/components/components').NComponent & {
            [key: string]: any;
        };
        interface HtmlTag {
            children?: unknown;
...
declare global {
    interface GlobalThis {
        ...
        __nojsxPageRoutes?: Record<string, {
